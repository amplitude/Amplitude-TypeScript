...
Shadow-DOM design notes, performance analysis, and planned follow-ups:
[`packages/plugin-autocapture-browser/SHADOW-DOM.md`](../packages/plugin-autocapture-browser/SHADOW-DOM.md).
