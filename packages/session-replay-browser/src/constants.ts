...
export const SESSION_REPLAY_SERVER_URL = 'https://api-sr.amplitude.com/sessions/track';
export const SESSION_REPLAY_EU_URL = 'https://api-sr.eu.amplitude.com/sessions/track';
