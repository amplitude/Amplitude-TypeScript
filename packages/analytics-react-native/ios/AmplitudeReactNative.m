...
RCT_EXTERN_METHOD(removeValue: (NSString*)instanceName key:(NSString*)key resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(removeLegacyEvent: (NSString*)instanceName rowId:(NSNumber*)rowId resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(removeLegacyIdentify: (NSString*)instanceName rowId:(NSNumber*)rowId resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(removeLegacyInterceptedIdentify: (NSString*)instanceName rowId:(NSNumber*)rowId resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
