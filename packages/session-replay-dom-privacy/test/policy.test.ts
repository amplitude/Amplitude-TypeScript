...
import { PrivacyConfig, getEffectiveMaskLevel, isMasked, maskFn, maskAttributeFn } from '../src';

const MASK_TEXT_CLASS = 'amp-mask';
const UNMASK_TEXT_CLASS = 'amp-unmask';

describe('DOM privacy policy', () => {
