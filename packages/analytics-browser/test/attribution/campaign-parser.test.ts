...
describe('campaign-parser', () => {
  describe('parse', () => {
    test('should return parameters', () => {
      ...
      jest.spyOn(parser, 'getUtmParam').mockReturnValue({
  ...
  describe('getUtmParam', () => {
    ...
    test('should return utm param from from cookies', () => {
      const parser = new CampaignParser();
      const getQueryParams = jest.spyOn(queryParams, 'getQueryParams').mockReturnValueOnce({});
      jest.spyOn(parser.utmCookieStorage, 'isEnabled').mockReturnValueOnce(true);
      jest.spyOn(parser.utmCookieStorage, 'get').mockReturnValueOnce({
        utmcsr: 'utmcsr',
        utmcmd: 'utmcmd',
        utmccn: 'utmccn',
        utmctr: 'utmctr',
