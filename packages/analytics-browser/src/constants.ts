...
export const DEFAULT_STREAM_STARTED_EVENT = `${DEFAULT_EVENT_PREFIX} Stream Started`;
export const DEFAULT_STREAM_STOPPED_EVENT = `${DEFAULT_EVENT_PREFIX} Stream Stopped`;
