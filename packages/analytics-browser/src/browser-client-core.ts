...
import { getAttributionTrackingConfig, isSessionTrackingEnabled } from './default-tracking';
...
import { isUserPropertyAttributionEnabled } from './attribution/tracking-methods';
...
export class AmplitudeBrowser extends AmplitudeCore implements BrowserClient, AnalyticsClient {
  ...
  protected async addPlugins() {
    // no-op. core client doesn't add any autocapture plugins
  }

  protected async addAttributionTrackingPlugin() {
    // no-op. core client doesn't do ootb attribution tracking
  }
}
