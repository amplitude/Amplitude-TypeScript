...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-cpmMO/DgX9J+/4+I7TuMduhppXe+JhmXfvAXVc8PbMiN1N1Vy7MzmOZDmq5sCaSq';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-2.44.2-feat-element-selectors.0-min.js.gz';
    as.onload = function () {
