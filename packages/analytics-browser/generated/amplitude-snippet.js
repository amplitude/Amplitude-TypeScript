...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-aqkobdGaWUFp/WZVX5htqhnkSq3Pf+bq4uHAMb2vkKY/fxspTsx+ZVZxHXv1Cwsi';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-2.18.0-networkcaptureprerelease.0-min.js.gz';
    as.onload = function () {
