...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-uT28pfsVrp3Slzduk9ssbRsnaVRQcQVDnlcBxQjqQlmVDmZujVI8T6xjerff/r2s';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.44.2-featelement-selector-v1.0-min.js.gz';
    as.onload = function () {
