...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-iQtDdSHSmoo3X6X7nchjhu7uItQ5vpm6CmTBbgMJwFcna/U8D7JS0FTSp3NaSyWe';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.30.2-zen-observable-migration.0-min.js.gz';
    as.onload = function () {
