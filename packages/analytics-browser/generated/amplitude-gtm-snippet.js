...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-OCwU/LJMMNtw6yLaT5QkPS2jif/XEYKk8ffsMyhoEpHGkoM76eLncDeZlRsq2RgB';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.46.0-video-analytics-4.0-min.js.gz';
    as.onload = function () {
