...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-h/OGGKDuvy1etRFJtEWMN/iAgzPAPoMBdpm7gyxWEy528vDRTfb2jFvhIls9H+BA';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.17.0-fixtypedefinition.0-min.js.gz';
    as.onload = function () {
