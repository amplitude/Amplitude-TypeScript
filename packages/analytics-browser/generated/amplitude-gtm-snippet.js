...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-l+wNjNPznWxDyzky039Jw6s+6IqW0kZDG++s/3/N1ECX3Nuf6Pk7/jc7+RzZLOy7';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.33.2-fake-branch-1141.0-min.js.gz';
    as.onload = function () {
