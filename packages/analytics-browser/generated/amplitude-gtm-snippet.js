...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-thS8Uprzxm9gx3v91WZyTwZtVRPKbG9b8n0BjJz+/l9Zl9EtEcpSdALbeDMU61pM';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.43.1-featzoning-selectors.0-min.js.gz';
    as.onload = function () {
