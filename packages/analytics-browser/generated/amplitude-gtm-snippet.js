...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-Ko0TbaSdMDDpHDRGbBxPOFA+4YnsBQIXRTzG8qqIFe7JR7AlZ0Cs+W4etzPaCrOp';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.18.0-fetchhardeningxhrsupport.0-min.js.gz';
    as.onload = function () {
