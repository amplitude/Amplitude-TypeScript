...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-NuDDgHmOpJmgHF2DF8OQUT87+REVTDAsMf8csO0COZPO2CYZwp9QC2zlUB1xVLS+';
    as.crossOrigin = 'anonymous';
    as.async = true;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-gtm-2.33.2-fake-branch.0-min.js.gz';
    as.onload = function () {
