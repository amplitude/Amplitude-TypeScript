...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-SV3ul2y0AKWFTUH1ddSejCxRCqeLvtjFUWUaCjcynsntsTrhEYvC3UIqz0SCbKrN';
    as.crossOrigin = 'anonymous';
    as.async = false;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-2.33.2-pnpm-migration.0-min.js.gz';
    as.onload = function () {
