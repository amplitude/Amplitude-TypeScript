...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-Cf60VaLNg+5/e8gFo2yPVPagWxxNATQVY0VKvVITeFKN5qUWckpWw3QWj1QttnDs';
    as.crossOrigin = 'anonymous';
    as.async = false;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-2.18.0-fetchhardeningxhrsupport.0-min.js.gz';
    as.onload = function () {
