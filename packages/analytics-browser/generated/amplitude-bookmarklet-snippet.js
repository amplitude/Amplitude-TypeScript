...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-NraS17dbQ9JO7w+qrloXDdvIMrFOXckLTJRp5ppcfkpvOL/hE+Bzzj6OTH4URx2m';
    as.crossOrigin = 'anonymous';
    as.async = false;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-2.17.7-networktrackingprereleasemay.0-min.js.gz';
    as.onload = function () {
