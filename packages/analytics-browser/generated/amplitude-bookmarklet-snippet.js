...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    as.integrity = 'sha384-yE0FhqWJbS+yDHM1vebpI23HCU1QDf79ul9uubSXTNFp39nccQMa5TIGZMRCPcV+';
    as.crossOrigin = 'anonymous';
    as.async = false;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-2.33.2-fake-branch-1141.0-min.js.gz';
    as.onload = function () {
