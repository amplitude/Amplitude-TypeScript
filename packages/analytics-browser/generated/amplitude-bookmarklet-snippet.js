...
!function (window, document) {
  ...
  if (amplitude.invoked) window.console && console.error && console.error('Amplitude snippet has been loaded.');else {
    ...
    autoTrackingPluginScript.src = 'https://cdn.amplitude.com/libs/plugin-default-event-tracking-advanced-browser-0.7.2-min.js.gz';
    autoTrackingPluginScript.async = false;
    s.parentNode.insertBefore(autoTrackingPluginScript, s);
    var as = document.createElement('script');
    as.type = 'text/javascript';
    as.integrity = 'sha384-BHj/6N+ZSiRDYRUHPEqr/nwkUsSk3s9r1ryQeFBc4x2OiVz4peW3jSccKZsoU8Ry';
    as.crossOrigin = 'anonymous';
    as.async = false;
    as.src = 'https://cdn.amplitude.com/libs/analytics-browser-2.6.2-beta.0-min.js.gz';
    as.onload = function () {
