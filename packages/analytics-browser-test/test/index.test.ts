  ...
  describe('custom config', () => {
    ...
    describe('debug mode', () => {
      test('should enable debug mode for track', async () => {
        ...
        expect(logger.debug).toHaveBeenCalledTimes(13);
        /* eslint-disable */
        const debugContext = JSON.parse(logger.debug.mock.calls[12]);
      ...
      test('should enable debug mode for setOptOut', async () => {
        ...
        /* eslint-disable */
        const debugContext = JSON.parse(logger.debug.mock.calls[6]);
        expect(debugContext.type).toBeDefined();
